      ...
      questions: [
        {
          ...
          answer: "Place of Power — это киберспортивная организация, которая помогает игрокам развивать свои навыки в различных дисциплинах. Мы предлагаем индивидуальные и групповые тренировки, проводим турниры и помогаем новичкам найти свою игру."
        },
        {
          question: "С какого возраста можно начать обучение?",
          answer: "Мы принимаем учеников от 10 лет. Для несовершеннолетних требуется согласие родителей. У нас есть специальные программы для разных возрастных групп."
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: "Индивидуальные тренировки проходят один на один с тренером. Мы анализируем вашу игру, выявляем слабые места и составляем персональную программу развития. Занятия проходят онлайн."
        },
        {
      ...
      questions: [
        {
          ...
          answer: "Для занятий нужен стабильный интернет (от 10 Мбит/с), компьютер или консоль с игрой, гарнитура с микрофоном."
        },
        {
          question: "Можно ли заниматься онлайн?",
          answer: "Да, все наши тренировки проходят онлайн. Мы используем современные платформы для видеосвязи и совместной работы."
        },
        {
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-lg text-gray-400 max-w-3xl mx-auto">
            Ответы на самые популярные вопросы о нашей киберспортивной организации. 
