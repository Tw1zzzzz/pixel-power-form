  ...
  const services = [
    {
      ...
      description: "Разработаем программу, адаптированную под ваши цели и игровые предпочтения, чтобы вы могли максимально эффективно развивать свои навыки. Продолжительность: 1-3 часа.",
      color: "from-blue-500 to-purple-600"
    },
    {
      icon: Users,
      title: "Групповые тренировки",
      description: "Участвуйте в групповых занятиях по выбранной дисциплине, работайте в команде и улучшайте свои навыки в конкурентной среде. Продолжительность: 1-3 часа.",
    ...
    },
    {
      ...
      description: "Киберспортивное обучение по разным направлениям - смягчаем порог вхождения в выбранную игру для новичков. Продолжительность занятий: 1-3 часа.",
    ...
    <section className="py-20 bg-gradient-to-b from-gray-900 to-black">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <div className="mt-6 p-6 bg-gray-800/50 rounded-2xl border border-gray-700 hover:border-red-500/50 transition-all duration-300 backdrop-blur-sm text-center">
            <p className="text-xl font-semibold text-white mb-3 flex items-center justify-center">
              <span className="text-2xl mr-3">⏱️</span>
              Продолжительность занятий
            </p>
            <p className="text-gray-300 leading-relaxed">Каждое занятие длится от 1 до 3 часов в зависимости от выбранной программы и ваших целей</p>
          </div>
        </div>
